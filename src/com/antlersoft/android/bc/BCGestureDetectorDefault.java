...
public class BCGestureDetectorDefault implements IBCGestureDetector {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.antlersoft.android.bc.IBCGestureDetector#createGestureDetector(
	 * android.content.Context, android.view.GestureDetector.OnGestureListener)
	 */
	@Override
	public GestureDetector createGestureDetector(Context context, OnGestureListener listener) {
