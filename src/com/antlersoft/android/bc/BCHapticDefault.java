...
class BCHapticDefault implements IBCHaptic {
	 ...
	 * 
	 * @see
	 * com.antlersoft.android.bc.IBCHaptic#performLongPressHaptic(android.view.
	 * View)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.antlersoft.android.bc.IBCHaptic#setIsHapticEnabled(android.view.View,
	 * boolean)
	 */
	/*
	 * @Override public boolean setIsHapticEnabled(View v, boolean enabled) {
