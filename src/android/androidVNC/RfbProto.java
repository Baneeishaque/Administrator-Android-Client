...
class RfbProto {
	...
	final static int AuthNone = 1, AuthVNC = 2, AuthUnixLogin = 129, AuthUltra = 17;
	...
	*/
	...
	synchronized void writeFramebufferUpdateRequest(int x, int y, int w, int h, boolean incremental)
			throws IOException {
	...
	synchronized void writeSetPixelFormat(int bitsPerPixel, int depth, boolean bigEndian, boolean trueColour,
