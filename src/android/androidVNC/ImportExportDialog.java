		...
		export.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				try {
					...
					SqliteElement.exportDbAsXmlToStream(_configurationDialog.getDatabaseHelper().getReadableDatabase(),
							writer);
					writer.close();
					dismiss();
		...
		((Button) findViewById(R.id.buttonImport)).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				try {
					...
					SqliteElement.importXmlStreamToDb(_configurationDialog.getDatabaseHelper().getWritableDatabase(),
							reader, ReplaceStrategy.REPLACE_EXISTING);
					dismiss();
