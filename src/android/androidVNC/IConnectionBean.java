...
interface IConnectionBean {
	...
	/**
	 * Records bitmap data implementation selection. 0 for auto, 1 for force
	 * full bitmap, 2 for force tiled
	 * <p>
	 * For historical reasons, this is named as if it were just a boolean
	 * selection for auto and force full.
	 * 
