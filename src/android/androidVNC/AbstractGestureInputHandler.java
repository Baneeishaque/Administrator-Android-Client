...
/**
 * An AbstractInputHandler that uses GestureDetector to detect standard gestures
 * in touch events
 * 
...
abstract class AbstractGestureInputHandler extends GestureDetector.SimpleOnGestureListener
	 ...
	 * 
	 * @see
	 * com.antlersoft.android.bc.OnScaleGestureListener#onScale(com.antlersoft.
	 * android.bc.IBCScaleGestureDetector)
	 */
	@Override
	public boolean onScale(IBCScaleGestureDetector detector) {
		boolean consumed = true;
		// if (detector.)
		// Log.i(TAG,"Focus("+detector.getFocusX()+","+detector.getFocusY()+")
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.antlersoft.android.bc.OnScaleGestureListener#onScaleBegin(com.
	 * antlersoft.android.bc.IBCScaleGestureDetector)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.antlersoft.android.bc.OnScaleGestureListener#onScaleEnd(com.
	 * antlersoft.android.bc.IBCScaleGestureDetector)
	 */
	@Override
