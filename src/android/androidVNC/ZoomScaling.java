...
class ZoomScaling extends AbstractScaling {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see android.androidVNC.AbstractScaling#zoomIn(android.androidVNC.
	 * VncCanvasActivity)
	 */
	@Override
	void zoomIn(VncCanvasActivity activity) {
		...
		// Log.v(TAG,String.format("before set matrix scrollx = %d scrolly =
		// %d", activity.vncCanvas.getScrollX(),
		// activity.vncCanvas.getScrollY()));
	 ...
	 * (non-Javadoc)
	 * 
	 * @see android.androidVNC.AbstractScaling#zoomOut(android.androidVNC.
	 * VncCanvasActivity)
	 */
	@Override
	void zoomOut(VncCanvasActivity activity) {
		...
		// activity.vncCanvas.getScrollY()));
		activity.vncCanvas.setImageMatrix(matrix);
		// Log.v(TAG,String.format("after set matrix scrollx = %d scrolly = %d",
		// activity.vncCanvas.getScrollX(), activity.vncCanvas.getScrollY()));
		resolveZoom(activity);
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see android.androidVNC.AbstractScaling#adjust(android.androidVNC.
	 * VncCanvasActivity, float, float, float)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see android.androidVNC.AbstractScaling#setScaleTypeForActivity(android.
	 * androidVNC.VncCanvasActivity)
	 */
	@Override
