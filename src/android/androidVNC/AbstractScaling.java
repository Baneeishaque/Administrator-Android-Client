...
abstract class AbstractScaling {
	 ...
	 * 
	 * @param activity
	 *            Activity containing to canvas to scale
	 * @param scaleFactor
	 *            Factor by which to adjust scaling
	 * @param fx
	 *            Focus X of center of scale change
	 * @param fy
	 *            Focus Y of center of scale change
	 */
